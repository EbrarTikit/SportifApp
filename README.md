...
Sprint Review: Alınan kararlar: Uygulamanın içeriği güncellenmiş ve sadeleştirilmiştir. Önceden belirtilen ürünün kısıtlı zamanda yeteri kadar ilgilenemeyeceğinden sadeleştirme kararı alınmıştır. Kullanıcı giriş sayfası, login, to do list oluşturulması hedeflenmiştir. Sprint 3 eklenenler listeleme yapıldı olarak görülmektedir.
